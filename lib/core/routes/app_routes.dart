...
class AppRoutes {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case missions: return MaterialPageRoute(builder: (_) => const MissionsPage());
      case missionDetail:
        return MaterialPageRoute(builder: (_) => const MissionDetailPage());
      case checkin: return MaterialPageRoute(builder: (_) => const AttendancePage());
      case checkout: return MaterialPageRoute(builder: (_) => const CheckoutPage());
      case payments: return MaterialPageRoute(builder: (_) => const PaymentsPage());
      case cpa: return MaterialPageRoute(builder: (_) => const CpaPage());
      case badges: return MaterialPageRoute(builder: (_) => const BadgesPage());
      case incident: return MaterialPageRoute(builder: (_) => const IncidentPage());
      case workers: return MaterialPageRoute(builder: (_) => const WorkersPage());
      case farmers: return MaterialPageRoute(builder: (_) => const FarmersPage());
      case profile: return MaterialPageRoute(builder: (_) => const ProfilePage());
      case trainings: return MaterialPageRoute(builder: (_) => const TrainingsPage());
      case admin: return MaterialPageRoute(builder: (_) => const AdminDashboardPage());
      default:
